...
public class RunJSTest extends WebDriverSettings {
    ...
    public void executeFirstMethodJs () throws InterruptedException {
        ...
        //TODO move to base myproject.page  = create method дождаться элемента на любой странице, который будет принимать локатор и время
        WebDriverWait wait = new WebDriverWait(driver, 10);
        wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(memberLocator));
        //List<WebElement> listMemberWebElements = myproject.driver.findElements(memberLocator);
